...
impl IFabricCodePackageActivationContext_Vtbl {
    ...
    >() -> IFabricCodePackageActivationContext_Vtbl {
        ...
        >(
            ...
            let this = (this as *const *const ()).offset(OFFSET) as *const Identity;
            let this = (*this).get_impl();
            match IFabricCodePackageActivationContext_Impl:: RegisterConfigurationPackageChangeHandler ( this , windows_core::from_raw_borrowed ( & callback ) , ) { Ok ( ok__ ) => { core::ptr::write ( callbackhandle , core::mem::transmute ( ok__ ) ) ; windows_core::HRESULT ( 0 ) } Err ( err ) => err . into ( ) }
        }
