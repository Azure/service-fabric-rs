...
impl std::ops::Deref for IFabricTransportCallbackMessageHandler {
...
impl std::ops::Deref for IFabricTransportClient {
    type Target = windows_core::IUnknown;
    fn deref(&self) -> &Self::Target {
        unsafe { std::mem::transmute(self) }
    }
...
impl std::ops::Deref for IFabricTransportClientConnection {
    type Target = windows_core::IUnknown;
    fn deref(&self) -> &Self::Target {
        unsafe { std::mem::transmute(self) }
    }
...
impl std::ops::Deref for IFabricTransportClientEventHandler {
    type Target = windows_core::IUnknown;
    fn deref(&self) -> &Self::Target {
        unsafe { std::mem::transmute(self) }
    }
...
impl std::ops::Deref for IFabricTransportConnectionHandler {
    type Target = windows_core::IUnknown;
    fn deref(&self) -> &Self::Target {
        unsafe { std::mem::transmute(self) }
    }
...
impl std::ops::Deref for IFabricTransportListener {
    type Target = windows_core::IUnknown;
    fn deref(&self) -> &Self::Target {
        unsafe { std::mem::transmute(self) }
    }
...
impl std::ops::Deref for IFabricTransportMessage {
    type Target = windows_core::IUnknown;
    fn deref(&self) -> &Self::Target {
        unsafe { std::mem::transmute(self) }
    }
...
impl std::ops::Deref for IFabricTransportMessageHandler {
    type Target = windows_core::IUnknown;
    fn deref(&self) -> &Self::Target {
        unsafe { std::mem::transmute(self) }
    }
...
impl Copy for FABRIC_TRANSPORT_LISTEN_ADDRESS {}
...
impl PartialEq for FABRIC_TRANSPORT_LISTEN_ADDRESS {
...
impl Eq for FABRIC_TRANSPORT_LISTEN_ADDRESS {}
...
impl Copy for FABRIC_TRANSPORT_MESSAGE_BUFFER {}
impl Clone for FABRIC_TRANSPORT_MESSAGE_BUFFER {
    fn clone(&self) -> Self {
        *self
    }
}
...
impl PartialEq for FABRIC_TRANSPORT_MESSAGE_BUFFER {
    fn eq(&self, other: &Self) -> bool {
        self.BufferSize == other.BufferSize && self.Buffer == other.Buffer
    }
}
impl Eq for FABRIC_TRANSPORT_MESSAGE_BUFFER {}
...
impl Copy for FABRIC_TRANSPORT_SETTINGS {}
impl Clone for FABRIC_TRANSPORT_SETTINGS {
    fn clone(&self) -> Self {
        *self
    }
}
...
impl PartialEq for FABRIC_TRANSPORT_SETTINGS {
    fn eq(&self, other: &Self) -> bool {
...
impl Eq for FABRIC_TRANSPORT_SETTINGS {}
