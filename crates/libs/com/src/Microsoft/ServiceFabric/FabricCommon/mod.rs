...
{
    windows_core::link!("" "C" fn FabricDecryptText(encryptedtext : windows_core::PCWSTR, certstorelocation : super::FabricTypes::FABRIC_X509_STORE_LOCATION, decryptedtext : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
...
where
    P0: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("" "C" fn FabricDecryptValue(encryptedvalue : windows_core::PCWSTR, decryptedvalue : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
{
    windows_core::link!("" "C" fn FabricEncryptText(text : windows_core::PCWSTR, certthumbprint : windows_core::PCWSTR, certstorename : windows_core::PCWSTR, certstorelocation : super::FabricTypes::FABRIC_X509_STORE_LOCATION, algorithmoid : windows_core::PCWSTR, encryptedvalue : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        FabricEncryptText(
            text.param().abi(),
...
where
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("" "C" fn FabricEncryptText2(text : windows_core::PCWSTR, certfilepath : windows_core::PCWSTR, algorithmoid : windows_core::PCWSTR, encryptedvalue : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        FabricEncryptText2(
            text.param().abi(),
...
where
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("" "C" fn FabricEncryptValue(certthumbprint : windows_core::PCWSTR, certstorename : windows_core::PCWSTR, text : windows_core::PCWSTR, encryptedvalue : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        FabricEncryptValue(
            certthumbprint.param().abi(),
...
impl IFabricAsyncOperationContext {
    ...
    pub unsafe fn get_Callback(&self) -> windows_core::Result<IFabricAsyncOperationCallback> {
        unsafe {
            let mut result__ = core::mem::zeroed();
            (windows_core::Interface::vtable(self).get_Callback)(
                windows_core::Interface::as_raw(self),
                &mut result__,
            )
            .and_then(|| windows_core::Type::from_abi(result__))
...
pub struct IFabricAsyncOperationContext_Vtbl {
    ...
    pub get_Callback: unsafe extern "system" fn(
        *mut core::ffi::c_void,
...
pub trait IFabricAsyncOperationContext_Impl: windows_core::IUnknownImpl {
    ...
    fn get_Callback(&self) -> windows_core::Result<IFabricAsyncOperationCallback>;
...
impl IFabricAsyncOperationContext_Vtbl {
    pub const fn new<Identity: IFabricAsyncOperationContext_Impl, const OFFSET: isize>() -> Self {
        ...
        unsafe extern "system" fn get_Callback<
            Identity: IFabricAsyncOperationContext_Impl,
            const OFFSET: isize,
        >(
            this: *mut core::ffi::c_void,
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IFabricAsyncOperationContext_Impl::get_Callback(this) {
                    Ok(ok__) => {
        ...
        Self {
            ...
            get_Callback: get_Callback::<Identity, OFFSET>,
...
impl IFabricGetReplicatorStatusResult {
    ...
    pub unsafe fn get_ReplicatorStatus(
        &self,
    ) -> *const super::FabricTypes::FABRIC_REPLICATOR_STATUS_QUERY_RESULT {
        unsafe {
...
#[repr(C)]
#[doc(hidden)]
pub struct IFabricGetReplicatorStatusResult_Vtbl { pub base__ : windows_core::IUnknown_Vtbl , # [cfg (feature = "ServiceFabric_FabricTypes")] pub get_ReplicatorStatus : unsafe extern "system" fn (* mut core::ffi::c_void ,) -> * const super::FabricTypes::FABRIC_REPLICATOR_STATUS_QUERY_RESULT , # [cfg (not (feature = "ServiceFabric_FabricTypes"))] get_ReplicatorStatus : usize , }
