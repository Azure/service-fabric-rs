...
impl std::ops::Deref for IFabricAsyncOperationCallback {
...
impl std::ops::Deref for IFabricAsyncOperationContext {
    type Target = windows_core::IUnknown;
    fn deref(&self) -> &Self::Target {
        unsafe { std::mem::transmute(self) }
    }
...
impl std::ops::Deref for IFabricGetReplicatorStatusResult {
    type Target = windows_core::IUnknown;
    fn deref(&self) -> &Self::Target {
        unsafe { std::mem::transmute(self) }
    }
...
impl std::ops::Deref for IFabricStringListResult {
    type Target = windows_core::IUnknown;
    fn deref(&self) -> &Self::Target {
        unsafe { std::mem::transmute(self) }
    }
...
impl std::ops::Deref for IFabricStringResult {
    type Target = windows_core::IUnknown;
    fn deref(&self) -> &Self::Target {
        unsafe { std::mem::transmute(self) }
    }
