...
{
    windows_core::link!("" "C" fn FabricBeginCreateRuntime(riid : *const windows_core::GUID, exithandler : *mut core::ffi::c_void, timeoutmilliseconds : u32, callback : *mut core::ffi::c_void, context : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
...
{
    windows_core::link!("" "C" fn FabricBeginGetActivationContext(riid : *const windows_core::GUID, timeoutmilliseconds : u32, callback : *mut core::ffi::c_void, context : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
where
    P2: windows_core::Param<super::FabricCommon::IFabricAsyncOperationCallback>,
{
    windows_core::link!("" "C" fn FabricBeginGetCodePackageActivator(riid : *const windows_core::GUID, timeoutmilliseconds : u32, callback : *mut core::ffi::c_void, context : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
{
    windows_core::link!("" "C" fn FabricBeginGetNodeContext(timeoutmilliseconds : u32, callback : *mut core::ffi::c_void, context : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[inline]
pub unsafe fn FabricCreateExtentLog<P2>(
    partitionid: super::FabricTypes::FABRIC_PARTITION_ID,
    replicaid: super::FabricTypes::FABRIC_REPLICA_ID,
    directorypath: P2,
) -> windows_core::Result<*mut core::ffi::c_void>
where
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("" "C" fn FabricCreateExtentLog(partitionid : super::FabricTypes::FABRIC_PARTITION_ID, replicaid : super::FabricTypes::FABRIC_REPLICA_ID, directorypath : windows_core::PCWSTR, result : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
        FabricCreateExtentLog(
            partitionid,
            replicaid,
...
#[cfg(feature = "ServiceFabric_FabricTypes")]
#[inline]
pub unsafe fn FabricCreateKeyValueStoreReplica<P1, P7, T>(
    storename: P1,
    partitionid: super::FabricTypes::FABRIC_PARTITION_ID,
    replicaid: super::FabricTypes::FABRIC_REPLICA_ID,
...
{
    windows_core::link!("" "C" fn FabricCreateKeyValueStoreReplica(riid : *const windows_core::GUID, storename : windows_core::PCWSTR, partitionid : super::FabricTypes::FABRIC_PARTITION_ID, replicaid : super::FabricTypes::FABRIC_REPLICA_ID, replicatorsettings : *const super::FabricTypes::FABRIC_REPLICATOR_SETTINGS, localstorekind : super::FabricTypes::FABRIC_LOCAL_STORE_KIND, localstoresettings : *const core::ffi::c_void, storeeventhandler : *mut core::ffi::c_void, keyvaluestore : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
...
#[cfg(feature = "ServiceFabric_FabricTypes")]
#[inline]
pub unsafe fn FabricCreateKeyValueStoreReplica2<P1, P7, P8, T>(
    storename: P1,
    partitionid: super::FabricTypes::FABRIC_PARTITION_ID,
    replicaid: super::FabricTypes::FABRIC_REPLICA_ID,
    replicatorsettings: *const super::FabricTypes::FABRIC_REPLICATOR_SETTINGS,
...
#[cfg(feature = "ServiceFabric_FabricTypes")]
#[inline]
pub unsafe fn FabricCreateKeyValueStoreReplica3<P1, P7, P8, T>(
    storename: P1,
    partitionid: super::FabricTypes::FABRIC_PARTITION_ID,
    replicaid: super::FabricTypes::FABRIC_REPLICA_ID,
    replicatorsettings: *const super::FabricTypes::FABRIC_REPLICATOR_SETTINGS,
...
where
    ...
    T: windows_core::Interface,
{
    windows_core::link!("" "C" fn FabricCreateKeyValueStoreReplica3(riid : *const windows_core::GUID, storename : windows_core::PCWSTR, partitionid : super::FabricTypes::FABRIC_PARTITION_ID, replicaid : super::FabricTypes::FABRIC_REPLICA_ID, replicatorsettings : *const super::FabricTypes::FABRIC_REPLICATOR_SETTINGS, localstorekind : super::FabricTypes::FABRIC_LOCAL_STORE_KIND, localstoresettings : *const core::ffi::c_void, storeeventhandler : *mut core::ffi::c_void, secondaryeventhandler : *mut core::ffi::c_void, notificationmode : super::FabricTypes::FABRIC_KEY_VALUE_STORE_NOTIFICATION_MODE, keyvaluestore : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    let mut result__ = core::ptr::null_mut();
    unsafe {
...
#[cfg(feature = "ServiceFabric_FabricTypes")]
#[inline]
pub unsafe fn FabricCreateKeyValueStoreReplica4<P1, P8, P9, T>(
    storename: P1,
    partitionid: super::FabricTypes::FABRIC_PARTITION_ID,
    replicaid: super::FabricTypes::FABRIC_REPLICA_ID,
...
where
    ...
    T: windows_core::Interface,
{
    windows_core::link!("" "C" fn FabricCreateKeyValueStoreReplica4(riid : *const windows_core::GUID, storename : windows_core::PCWSTR, partitionid : super::FabricTypes::FABRIC_PARTITION_ID, replicaid : super::FabricTypes::FABRIC_REPLICA_ID, servicename : super::FabricTypes::FABRIC_URI, replicatorsettings : *const super::FabricTypes::FABRIC_REPLICATOR_SETTINGS, localstorekind : super::FabricTypes::FABRIC_LOCAL_STORE_KIND, localstoresettings : *const core::ffi::c_void, storeeventhandler : *mut core::ffi::c_void, secondaryeventhandler : *mut core::ffi::c_void, notificationmode : super::FabricTypes::FABRIC_KEY_VALUE_STORE_NOTIFICATION_MODE, keyvaluestore : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    let mut result__ = core::ptr::null_mut();
    unsafe {
...
#[cfg(feature = "ServiceFabric_FabricTypes")]
#[inline]
pub unsafe fn FabricCreateKeyValueStoreReplica5<P1, P9, P10, T>(
    storename: P1,
    partitionid: super::FabricTypes::FABRIC_PARTITION_ID,
    replicaid: super::FabricTypes::FABRIC_REPLICA_ID,
    servicename: super::FabricTypes::FABRIC_URI,
...
#[inline]
pub unsafe fn FabricCreateRuntime<T>() -> windows_core::Result<T>
where
    T: windows_core::Interface,
{
    windows_core::link!("" "C" fn FabricCreateRuntime(riid : *const windows_core::GUID, fabricruntime : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    let mut result__ = core::ptr::null_mut();
    unsafe {
...
{
    windows_core::link!("" "C" fn FabricEndCreateRuntime(context : *mut core::ffi::c_void, fabricruntime : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
where
    P0: windows_core::Param<super::FabricCommon::IFabricAsyncOperationContext>,
{
    windows_core::link!("" "C" fn FabricEndGetActivationContext(context : *mut core::ffi::c_void, activationcontext : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
where
    P0: windows_core::Param<super::FabricCommon::IFabricAsyncOperationContext>,
{
    windows_core::link!("" "C" fn FabricEndGetCodePackageActivator(context : *mut core::ffi::c_void, activator : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
where
    P0: windows_core::Param<super::FabricCommon::IFabricAsyncOperationContext>,
{
    windows_core::link!("" "C" fn FabricEndGetNodeContext(context : *mut core::ffi::c_void, nodecontext : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
#[inline]
pub unsafe fn FabricGetActivationContext<T>() -> windows_core::Result<T>
where
    T: windows_core::Interface,
{
    windows_core::link!("" "C" fn FabricGetActivationContext(riid : *const windows_core::GUID, activationcontext : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    let mut result__ = core::ptr::null_mut();
    unsafe {
...
#[inline]
pub unsafe fn FabricGetCodePackageActivator<T>() -> windows_core::Result<T>
where
    T: windows_core::Interface,
{
    windows_core::link!("" "C" fn FabricGetCodePackageActivator(riid : *const windows_core::GUID, activator : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    let mut result__ = core::ptr::null_mut();
    unsafe {
...
pub unsafe fn FabricGetNodeContext() -> windows_core::Result<*mut core::ffi::c_void> {
    windows_core::link!("" "C" fn FabricGetNodeContext(nodecontext : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
where
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("" "C" fn FabricLoadEseLocalStoreSettings(codepackageactivationcontext : *mut core::ffi::c_void, configurationpackagename : windows_core::PCWSTR, sectionname : windows_core::PCWSTR, settings : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
where
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("" "C" fn FabricLoadReplicatorSettings(codepackageactivationcontext : *mut core::ffi::c_void, configurationpackagename : windows_core::PCWSTR, sectionname : windows_core::PCWSTR, replicatorsettings : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
where
    ...
    P2: windows_core::Param<windows_core::PCWSTR>,
{
    windows_core::link!("" "C" fn FabricLoadSecurityCredentials(codepackageactivationcontext : *mut core::ffi::c_void, configurationpackagename : windows_core::PCWSTR, sectionname : windows_core::PCWSTR, securitycredentials : *mut *mut core::ffi::c_void) -> windows_core::HRESULT);
    unsafe {
        let mut result__ = core::mem::zeroed();
...
pub type FnFabricMain = Option<
    unsafe extern "system" fn(
        runtime: windows_core::Ref<IFabricRuntime>,
        activationcontext: windows_core::Ref<IFabricCodePackageActivationContext>,
...
impl IExtentLogicalLog {
    ...
    #[cfg(feature = "ServiceFabric_FabricCommon")]
    pub unsafe fn EndOpen<P0>(&self, context: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<super::FabricCommon::IFabricAsyncOperationContext>,
    {
        unsafe {
    ...
    #[cfg(feature = "ServiceFabric_FabricCommon")]
    pub unsafe fn EndFlushWithMarker<P0>(&self, context: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<super::FabricCommon::IFabricAsyncOperationContext>,
    {
        unsafe {
    ...
    #[cfg(feature = "ServiceFabric_FabricCommon")]
    pub unsafe fn EndClose<P0>(&self, context: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<super::FabricCommon::IFabricAsyncOperationContext>,
    {
        unsafe {
...
impl IFabricAtomicGroupStateProvider {
    ...
    pub unsafe fn BeginAtomicGroupCommit<P2>(
        &self,
        atomicgroupid: super::FabricTypes::FABRIC_ATOMIC_GROUP_ID,
        commitsequencenumber: super::FabricTypes::FABRIC_SEQUENCE_NUMBER,
        callback: P2,
    ) -> windows_core::Result<super::FabricCommon::IFabricAsyncOperationContext>
    where
        P2: windows_core::Param<super::FabricCommon::IFabricAsyncOperationCallback>,
    ...
    #[cfg(feature = "ServiceFabric_FabricCommon")]
    pub unsafe fn EndAtomicGroupCommit<P0>(&self, context: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<super::FabricCommon::IFabricAsyncOperationContext>,
    {
        unsafe {
    ...
    pub unsafe fn BeginAtomicGroupRollback<P2>(
        &self,
        atomicgroupid: super::FabricTypes::FABRIC_ATOMIC_GROUP_ID,
        rollbackequencenumber: super::FabricTypes::FABRIC_SEQUENCE_NUMBER,
        callback: P2,
    ) -> windows_core::Result<super::FabricCommon::IFabricAsyncOperationContext>
    where
        P2: windows_core::Param<super::FabricCommon::IFabricAsyncOperationCallback>,
    ...
    #[cfg(feature = "ServiceFabric_FabricCommon")]
    pub unsafe fn EndAtomicGroupRollback<P0>(&self, context: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<super::FabricCommon::IFabricAsyncOperationContext>,
    {
        unsafe {
    ...
    pub unsafe fn BeginUndoProgress<P1>(
        &self,
        fromcommitsequencenumber: super::FabricTypes::FABRIC_SEQUENCE_NUMBER,
        callback: P1,
    ) -> windows_core::Result<super::FabricCommon::IFabricAsyncOperationContext>
    where
        P1: windows_core::Param<super::FabricCommon::IFabricAsyncOperationCallback>,
    ...
    #[cfg(feature = "ServiceFabric_FabricCommon")]
    pub unsafe fn EndUndoProgress<P0>(&self, context: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<super::FabricCommon::IFabricAsyncOperationContext>,
    {
        unsafe {
...
pub struct IFabricAtomicGroupStateProvider_Vtbl {
    ...
    pub BeginAtomicGroupCommit: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::FabricTypes::FABRIC_ATOMIC_GROUP_ID,
        super::FabricTypes::FABRIC_SEQUENCE_NUMBER,
        *mut core::ffi::c_void,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(
...
impl IFabricAtomicGroupStateReplicator {
    #[cfg(feature = "ServiceFabric_FabricTypes")]
    pub unsafe fn CreateAtomicGroup(
        &self,
    ) -> windows_core::Result<super::FabricTypes::FABRIC_ATOMIC_GROUP_ID> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    pub unsafe fn BeginReplicateAtomicGroupOperation<P1, P2>(
        ...
        operationdata: P1,
        callback: P2,
        operationsequencenumber: *mut super::FabricTypes::FABRIC_SEQUENCE_NUMBER,
    ) -> windows_core::Result<super::FabricCommon::IFabricAsyncOperationContext>
    where
    ...
    pub unsafe fn EndReplicateAtomicGroupOperation<P0>(
        &self,
        context: P0,
    ) -> windows_core::Result<super::FabricTypes::FABRIC_SEQUENCE_NUMBER>
    where
        P0: windows_core::Param<super::FabricCommon::IFabricAsyncOperationContext>,
    {
        unsafe {
    ...
    pub unsafe fn BeginReplicateAtomicGroupCommit<P1>(
        ...
        atomicgroupid: super::FabricTypes::FABRIC_ATOMIC_GROUP_ID,
        callback: P1,
        commitsequencenumber: *mut super::FabricTypes::FABRIC_SEQUENCE_NUMBER,
    ) -> windows_core::Result<super::FabricCommon::IFabricAsyncOperationContext>
    where
        P1: windows_core::Param<super::FabricCommon::IFabricAsyncOperationCallback>,
    {
    ...
    pub unsafe fn BeginReplicateAtomicGroupRollback<P1>(
        ...
        atomicgroupid: super::FabricTypes::FABRIC_ATOMIC_GROUP_ID,
        callback: P1,
        rollbacksequencenumber: *mut super::FabricTypes::FABRIC_SEQUENCE_NUMBER,
    ) -> windows_core::Result<super::FabricCommon::IFabricAsyncOperationContext>
    where
        P1: windows_core::Param<super::FabricCommon::IFabricAsyncOperationCallback>,
    {
...
pub struct IFabricAtomicGroupStateReplicator_Vtbl {
    ...
    pub CreateAtomicGroup: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        *mut super::FabricTypes::FABRIC_ATOMIC_GROUP_ID,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "ServiceFabric_FabricTypes"))]
    CreateAtomicGroup: usize,
    #[cfg(all(
        feature = "ServiceFabric_FabricCommon",
        feature = "ServiceFabric_FabricTypes"
    ))]
    pub BeginReplicateAtomicGroupOperation: unsafe extern "system" fn(
        ...
        *mut core::ffi::c_void,
        *mut core::ffi::c_void,
        *mut super::FabricTypes::FABRIC_SEQUENCE_NUMBER,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(all(
        feature = "ServiceFabric_FabricCommon",
...
pub trait IFabricAtomicGroupStateReplicator_Impl: windows_core::IUnknownImpl {
    fn CreateAtomicGroup(&self)
    -> windows_core::Result<super::FabricTypes::FABRIC_ATOMIC_GROUP_ID>;
    fn BeginReplicateAtomicGroupOperation(
        &self,
        atomicgroupid: super::FabricTypes::FABRIC_ATOMIC_GROUP_ID,
        operationdata: windows_core::Ref<IFabricOperationData>,
        callback: windows_core::Ref<super::FabricCommon::IFabricAsyncOperationCallback>,
        operationsequencenumber: *mut super::FabricTypes::FABRIC_SEQUENCE_NUMBER,
    ) -> windows_core::Result<super::FabricCommon::IFabricAsyncOperationContext>;
...
impl IFabricAtomicGroupStateReplicator_Vtbl {
    pub const fn new<Identity: IFabricAtomicGroupStateReplicator_Impl, const OFFSET: isize>() -> Self
    {
        ...
        >(
            this: *mut core::ffi::c_void,
            atomicgroupid: *mut super::FabricTypes::FABRIC_ATOMIC_GROUP_ID,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            ...
            unsafe {
                ...
                match IFabricAtomicGroupStateReplicator_Impl::EndReplicateAtomicGroupOperation(
                    ...
                    Ok(ok__) => {
                        operationsequencenumber.write(ok__);
                        windows_core::HRESULT(0)
                    }
                    Err(err) => err.into(),
                }
        ...
        >(
            ...
            unsafe {
                ...
                match IFabricAtomicGroupStateReplicator_Impl::EndReplicateAtomicGroupCommit(
                    ...
                    Ok(ok__) => {
                        commitsequencenumber.write(ok__);
                        windows_core::HRESULT(0)
                    }
                    Err(err) => err.into(),
                }
        ...
        >(
            ...
            unsafe {
                ...
                match IFabricAtomicGroupStateReplicator_Impl::EndReplicateAtomicGroupRollback(
                    ...
                    Ok(ok__) => {
                        rollbacksequencenumber.write(ok__);
                        windows_core::HRESULT(0)
                    }
                    Err(err) => err.into(),
                }
...
impl IFabricCodePackage2 {
    ...
    pub unsafe fn get_SetupEntryPointRunAsPolicy(
        &self,
    ) -> *const super::FabricTypes::FABRIC_RUNAS_POLICY_DESCRIPTION {
        unsafe {
...
impl IFabricCodePackageActivationContext {
    ...
    pub unsafe fn get_ServiceTypes(
        &self,
    ) -> *const super::FabricTypes::FABRIC_SERVICE_TYPE_DESCRIPTION_LIST {
        unsafe {
    ...
    pub unsafe fn get_ServiceGroupTypes(
        &self,
    ) -> *const super::FabricTypes::FABRIC_SERVICE_GROUP_TYPE_DESCRIPTION_LIST {
        unsafe {
    ...
    pub unsafe fn get_ApplicationPrincipals(
        &self,
    ) -> *const super::FabricTypes::FABRIC_APPLICATION_PRINCIPALS_DESCRIPTION {
        unsafe {
    ...
    pub unsafe fn get_ServiceEndpointResources(
        &self,
    ) -> *const super::FabricTypes::FABRIC_ENDPOINT_RESOURCE_DESCRIPTION_LIST {
        unsafe {
...
pub trait IFabricCodePackageActivationContext_Impl: windows_core::IUnknownImpl {
    ...
    fn RegisterCodePackageChangeHandler(
        &self,
        callback: windows_core::Ref<IFabricCodePackageChangeHandler>,
    ) -> windows_core::Result<i64>;
    ...
    fn RegisterConfigurationPackageChangeHandler(
        &self,
        callback: windows_core::Ref<IFabricConfigurationPackageChangeHandler>,
    ) -> windows_core::Result<i64>;
    ...
    fn RegisterDataPackageChangeHandler(
        &self,
        callback: windows_core::Ref<IFabricDataPackageChangeHandler>,
    ) -> windows_core::Result<i64>;
    ...
    -> Self {
        ...
        >(
            ...
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IFabricCodePackageActivationContext_Impl::RegisterConfigurationPackageChangeHandler (this , core::mem::transmute_copy (& callback) ,) { Ok (ok__) => { callbackhandle . write (ok__) ; windows_core::HRESULT (0) } Err (err) => err . into () }
            }
        }
...
impl IFabricCodePackageActivator {
    ...
    #[cfg(feature = "ServiceFabric_FabricCommon")]
    pub unsafe fn EndActivateCodePackage<P0>(&self, context: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<super::FabricCommon::IFabricAsyncOperationContext>,
    {
        unsafe {
    ...
    #[cfg(feature = "ServiceFabric_FabricCommon")]
    pub unsafe fn EndDeactivateCodePackage<P0>(&self, context: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<super::FabricCommon::IFabricAsyncOperationContext>,
    {
        unsafe {
...
pub trait IFabricCodePackageActivator_Impl: windows_core::IUnknownImpl {
    ...
    fn RegisterCodePackageEventHandler(
        &self,
        eventhandler: windows_core::Ref<IFabricCodePackageEventHandler>,
    ) -> windows_core::Result<u64>;
...
pub trait IFabricCodePackageChangeHandler_Impl: windows_core::IUnknownImpl {
    fn OnPackageAdded(
        &self,
        source: windows_core::Ref<IFabricCodePackageActivationContext>,
        codepackage: windows_core::Ref<IFabricCodePackage>,
    );
    fn OnPackageRemoved(
        &self,
        source: windows_core::Ref<IFabricCodePackageActivationContext>,
    ...
    fn OnPackageModified(
        &self,
        source: windows_core::Ref<IFabricCodePackageActivationContext>,
        previouscodepackage: windows_core::Ref<IFabricCodePackage>,
        codepackage: windows_core::Ref<IFabricCodePackage>,
    );
}
...
pub trait IFabricCodePackageEventHandler_Impl: windows_core::IUnknownImpl {
    fn OnCodePackageEvent(
        &self,
        source: windows_core::Ref<IFabricCodePackageActivator>,
        eventdesc: *const super::FabricTypes::FABRIC_CODE_PACKAGE_EVENT_DESCRIPTION,
    );
}
#[cfg(feature = "ServiceFabric_FabricTypes")]
...
impl IFabricConfigurationPackage {
    ...
    #[cfg(feature = "ServiceFabric_FabricTypes")]
    pub unsafe fn get_Settings(&self) -> *const super::FabricTypes::FABRIC_CONFIGURATION_SETTINGS {
        unsafe {
...
impl IFabricConfigurationPackage_Vtbl {
    pub const fn new<Identity: IFabricConfigurationPackage_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
        ) -> *const super::FabricTypes::FABRIC_CONFIGURATION_SETTINGS {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub trait IFabricConfigurationPackageChangeHandler_Impl: windows_core::IUnknownImpl {
    fn OnPackageAdded(
        &self,
        source: windows_core::Ref<IFabricCodePackageActivationContext>,
        configpackage: windows_core::Ref<IFabricConfigurationPackage>,
    );
    fn OnPackageRemoved(
        &self,
        source: windows_core::Ref<IFabricCodePackageActivationContext>,
    ...
    fn OnPackageModified(
        &self,
        source: windows_core::Ref<IFabricCodePackageActivationContext>,
        previousconfigpackage: windows_core::Ref<IFabricConfigurationPackage>,
        configpackage: windows_core::Ref<IFabricConfigurationPackage>,
    );
}
...
pub trait IFabricDataPackageChangeHandler_Impl: windows_core::IUnknownImpl {
    fn OnPackageAdded(
        &self,
        source: windows_core::Ref<IFabricCodePackageActivationContext>,
        datapackage: windows_core::Ref<IFabricDataPackage>,
    );
    fn OnPackageRemoved(
        &self,
        source: windows_core::Ref<IFabricCodePackageActivationContext>,
    ...
    fn OnPackageModified(
        &self,
        source: windows_core::Ref<IFabricCodePackageActivationContext>,
        previousdatapackage: windows_core::Ref<IFabricDataPackage>,
        datapackage: windows_core::Ref<IFabricDataPackage>,
    );
}
...
impl IFabricEseLocalStoreSettingsResult {
    ...
    pub unsafe fn get_Settings(
        &self,
    ) -> *const super::FabricTypes::FABRIC_ESE_LOCAL_STORE_SETTINGS {
        unsafe {
            (windows_core::Interface::vtable(self).get_Settings)(windows_core::Interface::as_raw(
                self,
            ))
...
pub trait IFabricEseLocalStoreSettingsResult_Impl: windows_core::IUnknownImpl {
    fn get_Settings(&self) -> *const super::FabricTypes::FABRIC_ESE_LOCAL_STORE_SETTINGS;
}
#[cfg(feature = "ServiceFabric_FabricTypes")]
...
impl IFabricKeyValueStoreItemEnumerator {
    pub unsafe fn MoveNext(&self) -> windows_core::HRESULT {
        unsafe {
...
impl IFabricKeyValueStoreItemEnumerator2 {
    pub unsafe fn TryMoveNext(&self) -> windows_core::Result<bool> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
{
    fn TryMoveNext(&self) -> windows_core::Result<bool>;
}
...
impl IFabricKeyValueStoreReplica {
    ...
    pub unsafe fn Remove<P0, P1>(
        ...
        transaction: P0,
        key: P1,
        checksequencenumber: super::FabricTypes::FABRIC_SEQUENCE_NUMBER,
    ) -> windows_core::HRESULT
    where
        P0: windows_core::Param<IFabricTransactionBase>,
        P1: windows_core::Param<windows_core::PCWSTR>,
...
impl IFabricKeyValueStoreReplica2 {
    pub unsafe fn Backup<P0>(&self, backupdirectory: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
    ...
    pub unsafe fn Restore<P0>(&self, backupdirectory: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
...
impl IFabricKeyValueStoreReplica3 {
    ...
    #[cfg(feature = "ServiceFabric_FabricCommon")]
    pub unsafe fn EndBackup<P0>(&self, context: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<super::FabricCommon::IFabricAsyncOperationContext>,
    {
        unsafe {
...
pub trait IFabricKeyValueStoreReplica3_Impl: IFabricKeyValueStoreReplica2_Impl {
    fn BeginBackup(
        ...
        backupdirectory: &windows_core::PCWSTR,
        backupoption: super::FabricTypes::FABRIC_STORE_BACKUP_OPTION,
        postbackuphandler: windows_core::Ref<IFabricStorePostBackupHandler>,
        callback: windows_core::Ref<super::FabricCommon::IFabricAsyncOperationCallback>,
    ) -> windows_core::Result<super::FabricCommon::IFabricAsyncOperationContext>;
    fn EndBackup(
        &self,
...
impl IFabricKeyValueStoreReplica4 {
    ...
    #[cfg(feature = "ServiceFabric_FabricCommon")]
    pub unsafe fn EndRestore<P0>(&self, context: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<super::FabricCommon::IFabricAsyncOperationContext>,
    {
        unsafe {
...
impl IFabricKeyValueStoreReplica7 {
    ...
    pub unsafe fn EnumerateByLSN<P0>(
        &self,
        transaction: P0,
        fromlsn: super::FabricTypes::FABRIC_SEQUENCE_NUMBER,
    ) -> windows_core::Result<IFabricKeyValueStoreItemEnumerator>
    where
        P0: windows_core::Param<IFabricTransactionBase>,
    {
    ...
    #[cfg(feature = "ServiceFabric_FabricTypes")]
    pub unsafe fn GetLastCommittedSequenceNumber(
        &self,
    ) -> windows_core::Result<super::FabricTypes::FABRIC_SEQUENCE_NUMBER> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
pub struct IFabricKeyValueStoreReplica7_Vtbl {
    ...
    #[cfg(not(feature = "ServiceFabric_FabricTypes"))]
    EnumerateKeysAndTombstonesByLSN: usize,
    #[cfg(feature = "ServiceFabric_FabricTypes")]
    ...
    #[cfg(not(feature = "ServiceFabric_FabricTypes"))]
    GetLastCommittedSequenceNumber: usize,
}
...
pub trait IFabricKeyValueStoreReplica7_Impl: IFabricKeyValueStoreReplica6_Impl {
    ...
    fn GetLastCommittedSequenceNumber(
        &self,
    ) -> windows_core::Result<super::FabricTypes::FABRIC_SEQUENCE_NUMBER>;
}
#[cfg(all(
...
impl IFabricKeyValueStoreReplica7_Vtbl {
    pub const fn new<Identity: IFabricKeyValueStoreReplica7_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            lastcommittedsequencenumber: *mut super::FabricTypes::FABRIC_SEQUENCE_NUMBER,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IFabricKeyValueStoreReplica7_Impl::GetLastCommittedSequenceNumber(this) {
                    Ok(ok__) => {
                        lastcommittedsequencenumber.write(ok__);
                        windows_core::HRESULT(0)
                    }
                    Err(err) => err.into(),
                }
...
impl IFabricKeyValueStoreReplica8 {
    pub unsafe fn TryAbortExistingTransactionsAndRejectWrites(&self) -> windows_core::Result<bool> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "ServiceFabric_FabricTypes")]
    pub unsafe fn GetLSNSplitPercentile(
        &self,
        percentile: i32,
    ) -> windows_core::Result<super::FabricTypes::FABRIC_SEQUENCE_NUMBER> {
        unsafe {
...
pub struct IFabricKeyValueStoreReplica8_Vtbl {
    ...
    pub TryAbortExistingTransactionsAndRejectWrites:
        unsafe extern "system" fn(*mut core::ffi::c_void, *mut bool) -> windows_core::HRESULT,
    #[cfg(feature = "ServiceFabric_FabricTypes")]
    pub GetLSNSplitPercentile: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        i32,
        *mut super::FabricTypes::FABRIC_SEQUENCE_NUMBER,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "ServiceFabric_FabricTypes"))]
    GetLSNSplitPercentile: usize,
}
...
pub trait IFabricKeyValueStoreReplica8_Impl: IFabricKeyValueStoreReplica7_Impl {
    fn TryAbortExistingTransactionsAndRejectWrites(&self) -> windows_core::Result<bool>;
    fn GetLSNSplitPercentile(
        &self,
        percentile: i32,
    ) -> windows_core::Result<super::FabricTypes::FABRIC_SEQUENCE_NUMBER>;
}
...
impl IFabricKeyValueStoreReplica8_Vtbl {
    pub const fn new<Identity: IFabricKeyValueStoreReplica8_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            readyforfinalmigration: *mut bool,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
                match IFabricKeyValueStoreReplica8_Impl::TryAbortExistingTransactionsAndRejectWrites(
                    ...
                    Ok(ok__) => {
                        readyforfinalmigration.write(ok__);
                        windows_core::HRESULT(0)
                    }
                    Err(err) => err.into(),
                }
        ...
        >(
            this: *mut core::ffi::c_void,
            percentile: i32,
            readyforfinalmigration: *mut super::FabricTypes::FABRIC_SEQUENCE_NUMBER,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
impl IFabricNodeContextResult {
    #[cfg(feature = "ServiceFabric_FabricTypes")]
    pub unsafe fn get_NodeContext(&self) -> *const super::FabricTypes::FABRIC_NODE_CONTEXT {
        unsafe {
...
pub struct IFabricNodeContextResult_Vtbl {
    ...
    pub get_NodeContext:
        unsafe extern "system" fn(
            *mut core::ffi::c_void,
        ) -> *const super::FabricTypes::FABRIC_NODE_CONTEXT,
    #[cfg(not(feature = "ServiceFabric_FabricTypes"))]
...
pub trait IFabricNodeContextResult_Impl: windows_core::IUnknownImpl {
    fn get_NodeContext(&self) -> *const super::FabricTypes::FABRIC_NODE_CONTEXT;
}
#[cfg(feature = "ServiceFabric_FabricTypes")]
...
impl IFabricOperation {
    #[cfg(feature = "ServiceFabric_FabricTypes")]
    pub unsafe fn get_Metadata(&self) -> *const super::FabricTypes::FABRIC_OPERATION_METADATA {
        unsafe {
            (windows_core::Interface::vtable(self).get_Metadata)(windows_core::Interface::as_raw(
                self,
            ))
    ...
    pub unsafe fn Acknowledge(&self) -> windows_core::HRESULT {
        unsafe {
...
pub struct IFabricOperation_Vtbl {
    ...
    pub get_Metadata:
        unsafe extern "system" fn(
            *mut core::ffi::c_void,
        ) -> *const super::FabricTypes::FABRIC_OPERATION_METADATA,
    #[cfg(not(feature = "ServiceFabric_FabricTypes"))]
    get_Metadata: usize,
    #[cfg(feature = "ServiceFabric_FabricTypes")]
...
pub trait IFabricOperation_Impl: windows_core::IUnknownImpl {
    fn get_Metadata(&self) -> *const super::FabricTypes::FABRIC_OPERATION_METADATA;
    fn GetData(
        &self,
        count: *mut u32,
    ) -> windows_core::Result<*mut super::FabricTypes::FABRIC_OPERATION_DATA_BUFFER>;
...
impl IFabricPrimaryReplicator {
    ...
    #[cfg(feature = "ServiceFabric_FabricCommon")]
    pub unsafe fn EndOnDataLoss<P0>(&self, context: P0) -> windows_core::Result<bool>
    where
        P0: windows_core::Param<super::FabricCommon::IFabricAsyncOperationContext>,
    {
        unsafe {
    ...
    #[cfg(feature = "ServiceFabric_FabricCommon")]
    pub unsafe fn EndWaitForCatchUpQuorum<P0>(&self, context: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<super::FabricCommon::IFabricAsyncOperationContext>,
    {
        unsafe {
    ...
    #[cfg(feature = "ServiceFabric_FabricCommon")]
    pub unsafe fn EndBuildReplica<P0>(&self, context: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<super::FabricCommon::IFabricAsyncOperationContext>,
    {
        unsafe {
...
pub struct IFabricPrimaryReplicator_Vtbl {
    ...
    pub RemoveReplica: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        super::FabricTypes::FABRIC_REPLICA_ID,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "ServiceFabric_FabricTypes"))]
    RemoveReplica: usize,
}
...
impl IFabricReplicator {
    ...
    #[cfg(feature = "ServiceFabric_FabricCommon")]
    pub unsafe fn EndChangeRole<P0>(&self, context: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<super::FabricCommon::IFabricAsyncOperationContext>,
    {
        unsafe {
    ...
    #[cfg(feature = "ServiceFabric_FabricCommon")]
    pub unsafe fn EndUpdateEpoch<P0>(&self, context: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<super::FabricCommon::IFabricAsyncOperationContext>,
    {
        unsafe {
    ...
    #[cfg(feature = "ServiceFabric_FabricTypes")]
    pub unsafe fn GetCurrentProgress(
        &self,
    ) -> windows_core::Result<super::FabricTypes::FABRIC_SEQUENCE_NUMBER> {
        unsafe {
            let mut result__ = core::mem::zeroed();
    ...
    #[cfg(feature = "ServiceFabric_FabricTypes")]
    pub unsafe fn GetCatchUpCapability(
        &self,
    ) -> windows_core::Result<super::FabricTypes::FABRIC_SEQUENCE_NUMBER> {
        unsafe {
            let mut result__ = core::mem::zeroed();
...
impl IFabricReplicator_Vtbl {
    pub const fn new<Identity: IFabricReplicator_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            lastsequencenumber: *mut super::FabricTypes::FABRIC_SEQUENCE_NUMBER,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
        ...
        >(
            this: *mut core::ffi::c_void,
            fromsequencenumber: *mut super::FabricTypes::FABRIC_SEQUENCE_NUMBER,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub trait IFabricReplicatorSettingsResult_Impl: windows_core::IUnknownImpl {
    fn get_ReplicatorSettings(&self) -> *const super::FabricTypes::FABRIC_REPLICATOR_SETTINGS;
}
#[cfg(feature = "ServiceFabric_FabricTypes")]
...
impl IFabricRuntime {
    ...
    #[cfg(feature = "ServiceFabric_FabricCommon")]
    pub unsafe fn EndRegisterStatefulServiceFactory<P0>(&self, context: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<super::FabricCommon::IFabricAsyncOperationContext>,
    {
        unsafe {
    ...
    #[cfg(feature = "ServiceFabric_FabricCommon")]
    pub unsafe fn EndRegisterServiceGroupFactory<P0>(&self, context: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<super::FabricCommon::IFabricAsyncOperationContext>,
    {
        unsafe {
...
pub trait IFabricRuntime_Impl: windows_core::IUnknownImpl {
    fn BeginRegisterStatelessServiceFactory(
        ...
        factory: windows_core::Ref<IFabricStatelessServiceFactory>,
        timeoutmilliseconds: u32,
        callback: windows_core::Ref<super::FabricCommon::IFabricAsyncOperationCallback>,
    ) -> windows_core::Result<super::FabricCommon::IFabricAsyncOperationContext>;
    ...
    fn BeginRegisterStatefulServiceFactory(
        &self,
        servicetypename: &windows_core::PCWSTR,
        factory: windows_core::Ref<IFabricStatefulServiceFactory>,
        timeoutmilliseconds: u32,
        callback: windows_core::Ref<super::FabricCommon::IFabricAsyncOperationCallback>,
    ) -> windows_core::Result<super::FabricCommon::IFabricAsyncOperationContext>;
    ...
    fn BeginRegisterServiceGroupFactory(
        ...
        factory: windows_core::Ref<IFabricServiceGroupFactory>,
        timeoutmilliseconds: u32,
        callback: windows_core::Ref<super::FabricCommon::IFabricAsyncOperationCallback>,
    ) -> windows_core::Result<super::FabricCommon::IFabricAsyncOperationContext>;
...
impl IFabricSecondaryEventHandler {
    pub unsafe fn OnCopyComplete<P0>(&self, enumerator: P0) -> windows_core::HRESULT
    where
    ...
    pub unsafe fn OnReplicationOperation<P0>(&self, enumerator: P0) -> windows_core::HRESULT
    where
...
pub trait IFabricSecondaryEventHandler_Impl: windows_core::IUnknownImpl {
    fn OnCopyComplete(
        &self,
        enumerator: windows_core::Ref<IFabricKeyValueStoreEnumerator>,
    ) -> windows_core::Result<()>;
    fn OnReplicationOperation(
        &self,
        enumerator: windows_core::Ref<IFabricKeyValueStoreNotificationEnumerator>,
    ) -> windows_core::Result<()>;
}
...
pub trait IFabricSecurityCredentialsResult_Impl: windows_core::IUnknownImpl {
    fn get_SecurityCredentials(&self) -> *const super::FabricTypes::FABRIC_SECURITY_CREDENTIALS;
}
#[cfg(feature = "ServiceFabric_FabricTypes")]
...
impl IFabricSelfReconfiguringConfigurationChangeRequest {
    ...
    pub unsafe fn get_ConfigurationChangeRequest(
        &self,
    ) -> *const super::FabricTypes::FABRIC_SELF_RECONFIGURING_CONFIGURATION_CHANGE_REQUEST {
        unsafe {
...
#[repr(C)]
#[doc(hidden)]
pub struct IFabricSelfReconfiguringConfigurationChangeRequest_Vtbl { pub base__ : windows_core::IUnknown_Vtbl , # [cfg (feature = "ServiceFabric_FabricTypes")] pub get_ConfigurationChangeRequest : unsafe extern "system" fn (* mut core::ffi::c_void ,) -> * const super::FabricTypes::FABRIC_SELF_RECONFIGURING_CONFIGURATION_CHANGE_REQUEST , # [cfg (not (feature = "ServiceFabric_FabricTypes"))] get_ConfigurationChangeRequest : usize , }
...
impl IFabricSelfReconfiguringServiceFactory {
    ...
    pub unsafe fn CreateInstance<P0>(
        ...
        partitionid: super::FabricTypes::FABRIC_PARTITION_ID,
        instanceid: super::FabricTypes::FABRIC_INSTANCE_ID,
...
pub struct IFabricSelfReconfiguringServiceFactory_Vtbl {
    ...
    pub CreateInstance: unsafe extern "system" fn(
        *mut core::ffi::c_void,
        ...
        u32,
        *const u8,
        super::FabricTypes::FABRIC_PARTITION_ID,
        super::FabricTypes::FABRIC_INSTANCE_ID,
        *mut *mut core::ffi::c_void,
    ) -> windows_core::HRESULT,
    #[cfg(not(feature = "ServiceFabric_FabricTypes"))]
...
impl IFabricServiceGroupFactoryBuilder {
    ...
    pub unsafe fn RemoveServiceFactory<P0>(&self, memberservicetype: P0) -> windows_core::HRESULT
    where
        P0: windows_core::Param<windows_core::PCWSTR>,
    {
        unsafe {
...
impl IFabricStateProvider {
    ...
    pub unsafe fn BeginUpdateEpoch<P2>(
        &self,
        epoch: *const super::FabricTypes::FABRIC_EPOCH,
        previousepochlastsequencenumber: super::FabricTypes::FABRIC_SEQUENCE_NUMBER,
        callback: P2,
    ) -> windows_core::Result<super::FabricCommon::IFabricAsyncOperationContext>
    where
        P2: windows_core::Param<super::FabricCommon::IFabricAsyncOperationCallback>,
    ...
    pub unsafe fn GetCopyState<P1>(
        &self,
        uptosequencenumber: super::FabricTypes::FABRIC_SEQUENCE_NUMBER,
...
impl IFabricStateProvider_Vtbl {
    pub const fn new<Identity: IFabricStateProvider_Impl, const OFFSET: isize>() -> Self {
        ...
        >(
            this: *mut core::ffi::c_void,
            sequencenumber: *mut super::FabricTypes::FABRIC_SEQUENCE_NUMBER,
        ) -> windows_core::HRESULT {
            unsafe {
                let this: &Identity =
                    &*((this as *const *const ()).offset(OFFSET) as *const Identity);
...
pub trait IFabricStatefulServicePartition_Impl: windows_core::IUnknownImpl {
    ...
    fn CreateReplicator(
        &self,
        stateprovider: windows_core::Ref<IFabricStateProvider>,
        replicatorsettings: *const super::FabricTypes::FABRIC_REPLICATOR_SETTINGS,
        replicator: windows_core::OutRef<IFabricReplicator>,
    ) -> windows_core::Result<IFabricStateReplicator>;
    fn ReportLoad(
        &self,
        metriccount: u32,
...
impl IFabricStatelessServicePartition4 {
    pub unsafe fn ReportCompletion(&self) -> windows_core::HRESULT {
        unsafe {
...
impl IFabricStorePostBackupHandler {
    ...
    #[cfg(feature = "ServiceFabric_FabricCommon")]
    pub unsafe fn EndPostBackup<P0>(&self, context: P0) -> windows_core::Result<bool>
    where
        P0: windows_core::Param<super::FabricCommon::IFabricAsyncOperationContext>,
    {
        unsafe {
...
impl IFabricTransactionBase {
    #[cfg(feature = "ServiceFabric_FabricTypes")]
    pub unsafe fn get_Id(&self) -> *const super::FabricTypes::FABRIC_TRANSACTION_ID {
        unsafe {
...
pub struct IFabricTransactionBase_Vtbl {
    pub base__: windows_core::IUnknown_Vtbl,
    #[cfg(feature = "ServiceFabric_FabricTypes")]
    pub get_Id: unsafe extern "system" fn(
        *mut core::ffi::c_void,
    ) -> *const super::FabricTypes::FABRIC_TRANSACTION_ID,
    #[cfg(not(feature = "ServiceFabric_FabricTypes"))]
    get_Id: usize,
    #[cfg(feature = "ServiceFabric_FabricTypes")]
...
pub trait IFabricTransactionBase_Impl: windows_core::IUnknownImpl {
    fn get_Id(&self) -> *const super::FabricTypes::FABRIC_TRANSACTION_ID;
