...
use mssf_com::FabricTypes::{
    FABRIC_APPLICATION_UPGRADE_STATE, FABRIC_UPGRADE_DOMAIN_STATE,
...
impl From<FABRIC_APPLICATION_UPGRADE_STATE> for ApplicationUpgradeState {
    fn from(value: FABRIC_APPLICATION_UPGRADE_STATE) -> Self {
        match value {
            ...
            FABRIC_APPLICATION_UPGRADE_STATE::FABRIC_APPLICATION_UPGRADE_STATE_ROLLING_BACK_COMPLETED => Self::RollingBackCompleted,
            FABRIC_APPLICATION_UPGRADE_STATE::FABRIC_APPLICATION_UPGRADE_STATE_ROLLING_FORWARD_PENDING => Self::RollingForwardPending,
            ...
            FABRIC_APPLICATION_UPGRADE_STATE::FABRIC_APPLICATION_UPGRADE_STATE_FAILED => Self::Failed,
            FABRIC_APPLICATION_UPGRADE_STATE::FABRIC_APPLICATION_UPGRADE_STATE_ROLLING_BACK_PENDING => Self::RollingBackPending,
            _ => Self::Invalid,
        }
    }
}
...
impl From<FABRIC_UPGRADE_DOMAIN_STATE> for UpgradeDomainState {
    fn from(value: FABRIC_UPGRADE_DOMAIN_STATE) -> Self {
        match value {
            FABRIC_UPGRADE_DOMAIN_STATE::FABRIC_UPGRADE_DOMAIN_STATE_PENDING => Self::Pending,
            FABRIC_UPGRADE_DOMAIN_STATE::FABRIC_UPGRADE_DOMAIN_STATE_IN_PROGRESS => {
                Self::InProgress
            }
            FABRIC_UPGRADE_DOMAIN_STATE::FABRIC_UPGRADE_DOMAIN_STATE_COMPLETED => Self::Completed,
            _ => Self::Invalid,
        }
    }
}
