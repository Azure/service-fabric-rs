...
mod service;
pub use service::{
    DeleteServiceDescription, NamedRepartitionDescription, SelfReconfiguringServiceDescription,
    SelfReconfiguringServiceQueryResultItem, ServiceDescription, ServiceHealthQueryDescription,
