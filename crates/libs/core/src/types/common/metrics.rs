...
use mssf_com::FabricTypes::{FABRIC_LOAD_METRIC, FABRIC_MOVE_COST};
...
impl From<FABRIC_MOVE_COST> for MoveCost {
    fn from(value: FABRIC_MOVE_COST) -> Self {
        match value {
            FABRIC_MOVE_COST::FABRIC_MOVE_COST_ZERO => Self::Zero,
            FABRIC_MOVE_COST::FABRIC_MOVE_COST_LOW => Self::Low,
            FABRIC_MOVE_COST::FABRIC_MOVE_COST_MEDIUM => Self::Medium,
            FABRIC_MOVE_COST::FABRIC_MOVE_COST_HIGH => Self::High,
            FABRIC_MOVE_COST::FABRIC_MOVE_COST_VERYHIGH => Self::VeryHigh,
            _ => Self::Zero,
        }
    }
}
...
impl From<MoveCost> for FABRIC_MOVE_COST {
    fn from(value: MoveCost) -> Self {
        match value {
            MoveCost::Zero => FABRIC_MOVE_COST::FABRIC_MOVE_COST_ZERO,
            MoveCost::Low => FABRIC_MOVE_COST::FABRIC_MOVE_COST_LOW,
            MoveCost::Medium => FABRIC_MOVE_COST::FABRIC_MOVE_COST_MEDIUM,
            MoveCost::High => FABRIC_MOVE_COST::FABRIC_MOVE_COST_HIGH,
            MoveCost::VeryHigh => FABRIC_MOVE_COST::FABRIC_MOVE_COST_VERYHIGH,
        }
    }
}
