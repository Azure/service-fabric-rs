...
use mssf_com::FabricTypes::{
    FABRIC_ESE_LOCAL_STORE_SETTINGS, FABRIC_LOCAL_STORE_KIND, FABRIC_REPLICATOR_SETTINGS,
...
impl From<LocalStoreKind> for FABRIC_LOCAL_STORE_KIND {
    fn from(val: LocalStoreKind) -> Self {
        match val {
            LocalStoreKind::Ese => FABRIC_LOCAL_STORE_KIND::FABRIC_LOCAL_STORE_KIND_ESE,
            LocalStoreKind::Invalid => FABRIC_LOCAL_STORE_KIND::FABRIC_LOCAL_STORE_KIND_INVALID,
        }
    }
}
...
impl From<FABRIC_TRANSACTION_ISOLATION_LEVEL> for TransactionIsolationLevel {
    fn from(e: FABRIC_TRANSACTION_ISOLATION_LEVEL) -> Self {
        match e {
            FABRIC_TRANSACTION_ISOLATION_LEVEL::FABRIC_TRANSACTION_ISOLATION_LEVEL_DEFAULT => TransactionIsolationLevel::Default,
            ...
            FABRIC_TRANSACTION_ISOLATION_LEVEL::FABRIC_TRANSACTION_ISOLATION_LEVEL_SNAPSHOT => TransactionIsolationLevel::Snapshot,
